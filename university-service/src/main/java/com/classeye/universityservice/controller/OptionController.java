...
public class OptionController {
    ...
    @PostMapping
    public ResponseEntity<OptionResponseDto> createOption(@RequestBody @Valid OptionDTO optionDTO) {
        return ResponseEntity.ok(optionService.createOption(optionDTO));
    }

    @PutMapping("/{id}")
    public ResponseEntity<OptionResponseDto> updateOption(@PathVariable Long id, @RequestBody @Valid OptionDTO optionDTO) {
...
//        return ResponseEntity.ok(optionService.get(id));
//    }
}
